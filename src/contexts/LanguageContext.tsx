...
const translations = {
  en: {
    ...
    features: 'Features',
    aiAdvisory: 'Expert Farm Advisory',
    aiAdvisoryDesc: 'Get personalized farming advice using smart predictive systems',
    marketLinkage: 'Soil & Climate IoT',
    marketLinkageDesc: 'Monitor real-time soil moisture, temperature, and nutrients',
    cropDiagnosis: 'Crop Disease Diagnosis',
    cropDiagnosisDesc: 'Diagnose crop diseases using leaf image pathology analysis',
  ...
  hi: {
    ...
    learnMore: 'और जानें',
    features: 'विशेषताएं',
    aiAdvisory: 'स्मार्ट कृषि सलाहकार',
    aiAdvisoryDesc: 'उन्नत विश्लेषण का उपयोग करके व्यक्तिगत खेती की सलाह प्राप्त करें',
    marketLinkage: 'मिट्टी और जलवायु IoT',
    marketLinkageDesc: 'वास्तविक समय में मिट्टी की नमी, तापमान और पोषक तत्वों की निगरानी करें',
    cropDiagnosis: 'फसल रोग निदान',
    cropDiagnosisDesc: 'छवि विश्लेषण का उपयोग करके फसल रोगों का निदान करें',
    ...
    farms: 'खेत',
    addFarm: 'खेत जोड़ें',
    cropVariety: 'फ़सल की किस्म',
    soilType: 'मिट्टी का प्रकार',
    irrigationType: 'सिंचाई का प्रकार',
    acreage: 'एकड़ (क्षेत्रफल)',
  ...
  gu: {
    ...
    learnMore: 'વધુ જાણો',
    features: 'લક્ષણો',
    aiAdvisory: 'સ્માર્ટ ખેતી સલાહ',
    aiAdvisoryDesc: 'અદ્યતન પદ્ધતિઓનો ઉપયોગ કરીને વ્યક્તિગત ખેતીની સલાહ મેળવો',
    marketLinkage: 'માટી અને આબોહવા IoT',
    marketLinkageDesc: 'રીઅલ-ટાઇમ માટીનો ભેજ, તાપમાન અને પોષક તત્વોની દેખરેખ રાખો',
    cropDiagnosis: 'પાક રોગ નિદાન',
    cropDiagnosisDesc: 'છબી વિશ્લેષણનો ઉપયોગ કરીને પાક રોગોનું નિદાન કરો',
