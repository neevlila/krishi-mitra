    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8 fade-in-up-3d">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <Card className="h-fit glass-panel border border-border/40 shadow-lg hover:shadow-xl hover:shadow-accent/5 transition-all duration-300">
            <CardHeader>
            ...
            <CardContent className="space-y-4">
              <div className="relative group/input flex items-center justify-center border-2 border-dashed border-border hover:border-accent/40 rounded-xl p-6 bg-background/30 backdrop-blur transition-all duration-300">
                <Input
                  type="file"
                  accept="image/*"
                ...
                />
                <div className="flex flex-col items-center gap-2 text-muted-foreground group-hover/input:text-foreground transition-colors duration-300">
                  <Camera className="w-8 h-8 text-accent/80 animate-pulse" />
                  <span className="text-xs font-semibold">{imageFile ? imageFile.name : t('uploadImage')}</span>
                </div>
              </div>
              {imageFile && (
              ...
              <Button
                ...
                className="w-full bg-gradient-to-r from-emerald-600 to-primary hover:from-emerald-500 hover:to-primary/95 text-white"
              >
          ...
          <Card className="glass-panel border border-border/40 shadow-lg hover:shadow-xl hover:shadow-accent/5 transition-all duration-300">
            <CardHeader className="flex flex-row items-center justify-between border-b border-border/20 pb-4">
              <CardTitle className="text-foreground">Diagnosis History</CardTitle>
